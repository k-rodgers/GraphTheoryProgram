...
/*
 This is the .cpp file for the Hypercube2Random object.
 */

//Desc: Constructor for the Hypercube2Random object. Constructs a Hypercube2Random of Nodes,
//		and creates edges between them.
//Input: int i for the number of Nodes
Hypercube2Random::Hypercube2Random(int i, int j, bool b, int k)
{
	gameNumber = i;
	edgeWeight = j;
	totalGames = k;
...
//Desc: Destructor for the Hypercube2Random object. Deletes the nodeList
//		and frees up memory.
Hypercube2Random::~Hypercube2Random()
{
...
void Hypercube2Random::createInitialEdges()
{
	if (edgeWeight == 0)
    {
...
void Hypercube2Random::createInitialNodes(int i)
{
	Node *n = new Node(i);
	nodeList.push_back(n);
}

void Hypercube2Random::removeEdge()
{
	int n1 = 0;
	int n2 = 0;
...
void Hypercube2Random::printVersion()
{
	std::cout << std::endl;
...
void Hypercube2Random::rotateBar()
{
	barCount++;
	char barspin[4] = {'\\', '|', '/', '-'};
	int whichOne;
