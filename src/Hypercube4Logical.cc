...
//Desc: Constructor for the Hypercube4Logical object. Constructs a Hypercube4Logical of Nodes,
//		and creates edges between them.
//Input: int i for the number of Nodes
Hypercube4Logical::Hypercube4Logical(int i, int j, bool b, int k)
{
	gameNumber = i;
	edgeWeight = j;
	totalGames = k;
...
//Desc: Destructor for the Hypercube4Logical object. Deletes the nodeList
//		and frees up memory.
Hypercube4Logical::~Hypercube4Logical()
{
...
void Hypercube4Logical::createInitialEdges()
{
	if (edgeWeight == 0)
    {
...
void Hypercube4Logical::createInitialNodes(int i)
{
	Node *n = new Node(i);
	nodeList.push_back(n);
}

void Hypercube4Logical::removeEdge()
{
	int n1 = 0;
	int n2 = 0;
...
void Hypercube4Logical::printVersion()
{
	std::cout << std::endl;
...
void Hypercube4Logical::rotateBar()
{
	barCount++;
	char barspin[4] = {'\\', '|', '/', '-'};
	int whichOne;
